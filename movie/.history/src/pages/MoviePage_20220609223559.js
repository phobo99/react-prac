...
const MoviePage = () => {
  ...
  useEffect(() => {
    if (filterDebounce) {
      setUrl(
        "https://api.themoviedb.org/3/search/movie?api_key=8770f9570b6404aec4d862d9f76e3098"
      );
    } else {
      setUrl(
        `https://api.themoviedb.org/3/movie/popular?api_key=8770f9570b6404aec4d862d9f76e3098&query=${filterDebounce}`
      );
    }
  }, []);
