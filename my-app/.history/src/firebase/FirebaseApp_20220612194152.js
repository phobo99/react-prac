...
const FirebaseApp = () => {
  ...
  useEffect(() => {
    ...
    const docRefSingle = doc(db, "posts", "HIUZkjTGiH7btYAU5OvT");
  ...
  useEffect(() => {
    ...
    const q = query(colRef, orderBy("author"), limit(3));
    ...
    <div>
      ...
      <div className="w-full max-w-[500px] mx-auto bg-white shadow-lg p-5 mb-10">
        <form onSubmit={handleRemovePost}>
          ...
          <button
            type="submit"
            className="p-3 bg-blue-500 text-white bg-red-500 text-sm font-medium w-full rounded-lg"
          >
            Remove post
          </button>
        </form>
